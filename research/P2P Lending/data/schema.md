...
| 2026-07-26 | **T2.3 dùng thử lược đồ mới — không phát sinh sửa đổi nào.** `data/uk.md` (51 dòng) chạy hết 12 kiểm của §12 bằng trình kiểm tự động, PASS. Đoạn biến thể §7.1, mã `LOITUC`, và ngoại lệ §12.1 đều dùng được nguyên trạng trên một nước có cấu trúc nguồn ngược hẳn Trung Quốc. Lược đồ coi như ổn định sau hai file dữ liệu |
